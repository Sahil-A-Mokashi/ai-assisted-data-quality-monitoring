...
All generated suggestions were reviewed, modified and integrated by the author before being included in the final solution, second hald section of the given chat link.
link - https://claude.ai/share/a5cb2330-a8ca-439a-85d7-496c5fb3434f

deployment process, use of sqllite, login & bootstrap also referred from an old project of mine - https://github.com/Sahil-A-Mokashi/ecom
rule based (current)/ ml based (future) data pipeline and its workflow referred -  https://github.com/Sahil-A-Mokashi/Product-Review-Sentiment-Analysis-Pipeline
